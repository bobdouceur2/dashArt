...
import 'sculptures_model.dart';
export 'sculptures_model.dart';

class SculpturesWidget extends StatefulWidget {
  const SculpturesWidget({super.key});
...
class _SculpturesWidgetState extends State<SculpturesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SculpturesModel());
  }
